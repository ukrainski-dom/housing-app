...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='resource',
            field=models.CharField(choices=[('home', 'House'), ('flat', 'Apartment'), ('room', 'Room'), ('couch', 'Couch'), ('mattress', 'Mattress'), ('two_rooms', 'Two rooms'), ('room_in_own_house', 'Room in own house'), ('separate_part_of_apartment', 'Separate part of an apartment'), ('bed_in_shared_room', 'Bed in shared room'), ('place_in_hotel', 'Place in hotel, hostel or guesthouse')], max_length=1024, verbose_name='Resource'),
        ),
        migrations.AddField(
            model_name='housingresource',
            name='resource_other',
        ...
        migrations.AddField(
            model_name='housingresource',
            name='animals_other',
            field=models.CharField(blank=True, help_text='Other animals', max_length=512, null=True, verbose_name='Other animals'),
        ),
        migrations.AddField(
            model_name='housingresource',
        ...
        migrations.AddField(
            ...
            field=models.CharField(help_text='Other facilities', max_length=1024, null=True, verbose_name='Other facilities'),
        ),
        migrations.AddField(
            model_name='housingresource',
            name='groups',
        ...
        migrations.AddField(
            model_name='housingresource',
            name='voivodeship',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='main.voivodeship'),
        ),
